...
if __name__ == "__main__":
  ...
  if (args.action in ('update', 'download', 'delete')):
    if not (args.captionid or args.videoid):
          exit("Please specify EITHER VIDEOID OR captionid using the --captionid= parameter.")
    ...
    if args.action == 'upload':
      ...
      update_caption(youtube, args.captionid, args.file);
        ...
        if not args.captionid:
            download_caption_byVidID(youtube, args.videoid, 'srt')
        elif not args.videoid:
